...
namespace DUR.Api.Repo.Nextcloud
{
    public class NextcloudUnitOfWork : IDisposable, INextcloudUnitOfWork
    {
        ...
        public NextcloudUnitOfWork(bool isNew, NextcloudInterfaceSettings nextcloudInterfaceSettings, GeneralSettings settings)
        {
            if (isNew)
            {
                _settings = settings;
        ...
        public INextcloudUnitOfWork GetCurrent(NextcloudInterfaceSettings nextcloudInterfaceSettings, GeneralSettings settings)
        {
