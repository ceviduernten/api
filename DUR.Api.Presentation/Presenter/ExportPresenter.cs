...
public class ExportPresenter : IExportPresenter
{
    ...
    public ExportPresenter(IBoxPresenter boxPresenter, IItemService itemService,
        IStorageLocationPresenter storageLocationPresenter, IMapper mapper)
    {
        _mapper = mapper;
    ...
    public ExportRM<ItemExportRM> GetInventoryByLocation(Guid location)
    {
        ...
        var items = _itemService.GetAll()
            .Where(elem => elem.Location != null && elem.Location.IdStorageLocation == location).ToList();
        var itemsInBoxes = _itemService.GetAll()
            .Where(elem => elem.Box != null && elem.Box.Location.IdStorageLocation == location).ToList();
        ...
        {
            Description = "Inventarliste vom Lagerort " + loc.ShortName + ", an der Adresse " + loc.Address + ", " +
                          loc.Zip + " " + loc.City,
