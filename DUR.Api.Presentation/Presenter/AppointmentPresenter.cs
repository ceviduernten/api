...
public class AppointmentPresenter : BasePresenter<AppointmentRM, Appointment>, IAppointmentPresenter
{
    ...
    public AppointmentPresenter(IMapper mapper, IAppointmentService appointmentService,
        IGroupMailService groupMailService, IAppointmentResponseService appointmentResponseService) : base(
        appointmentService, mapper)
    {
