...
namespace DUR.Api.Presentation.Presenter
{
    public class HuntLocationPresenter : BasePresenter<HuntLocationRM, HuntLocation>, IHuntLocationPresenter
    {
        ...
        public HuntLocationPresenter(IMapper mapper, IMemoryCache cache, IHuntLocationService huntLocationService, IHuntCityService huntCityService) : base(huntLocationService, mapper)
        {
